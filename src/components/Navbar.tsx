...
import goToTitle, { scrollToTop } from "@/lib/goToTitle";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center absolute left-1/2 transform -translate-x-1/2">
              <div className="flex items-center space-x-8 rtl:space-x-reverse">
                <Link to="/" className="hover:opacity-80 transition-opacity" onClick={() => { closeMenu(); scrollToTop(); }}>
                  الرئيسية
                </Link>
                <button type="button" onClick={() => { closeMenu(); if (!goToTitle('الخدمات')) { navigate('/'); scrollToTop(); } }} className="hover:opacity-80 transition-opacity">
                  خدمات
                </button>
                <Link to="/transport" className="hover:opacity-80 transition-opacity" onClick={() => { closeMenu(); scrollToTop(); }}>
                  وسائل النقل
                </Link>
                <Link to="/restaurants" className="hover:opacity-80 transition-opacity" onClick={() => { closeMenu(); scrollToTop(); }}>
                  المطاعم
                </Link>
                <Link to="/about" className="hover:opacity-80 transition-opacity" onClick={() => { closeMenu(); scrollToTop(); }}>
                  من نحن
                </Link>
                <button type="button" onClick={() => { closeMenu(); if (!goToTitle('اتصل بنا')) { navigate('/'); scrollToTop(); } }} className="hover:opacity-80 transition-opacity">
                  اتصل بنا
                </button>
              </div>
            </div>
